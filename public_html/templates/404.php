...
<body>
	<div class="header">
	<a href="https://www.websmaking.com/" class="logo"><img src="https://i.websmaking.com/images/custom-logo.svg" style="width: 200px;"></a>
	<a class="login" href="https://www.websmaking.com/?do=register">בנה אתר</div></a>
	</div>
	<div class="txt-page">
		גולש יקר, האתר או התוכן אליו ניסית לגשת לא קיים.<br>
		<br>
		אפשרויות:<br>
		<br>
		• אם הזנת כתובת של אתר (www.websmaking.com/example) וקיבלת את ההודעה שגיאה הזאת, מזל טוב - הכתובת פנויה ואפשרית לפתיחת אתר
		<br>
		• וודא שהכתובת שהקשת בשורת הכתובות בדפדפן נכונה
		<br>
		• חזור לעמוד הבית של <a href="https://www.websmaking.com">www.websmaking.com</a>
	</div>
	<div class="main">
  <div>
